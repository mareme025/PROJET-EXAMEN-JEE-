...
/**
 * Servlet implementation class EditEntrepriseServlet
 */
@WebServlet("/EditEntreprise")
public class EditEntrepriseServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if(request.getSession().getAttribute("user_session") != null) 
		{
			...
			request.getRequestDispatcher("view/entreprise/edit.jsp").forward(request, response);	
		} 
		else 
		{
